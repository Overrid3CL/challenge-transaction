...
-- ==========================================
-- Description: System users (Tenpistas and administrators)
...
CREATE TABLE "user" (
    ...
    phone VARCHAR(20),
    user_type VARCHAR(20) DEFAULT 'TENPISTA' NOT NULL,
    ...
    -- Constraints
    CONSTRAINT chk_user_type CHECK (user_type IN ('TENPISTA', 'ADMIN')),
...
COMMENT ON COLUMN "user".user_type IS 'Type of user: TENPISTA or ADMIN';
